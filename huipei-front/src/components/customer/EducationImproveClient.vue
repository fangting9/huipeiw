<template>
    <div>
        ...
        <el-row :gutter="20">
            <div style="width: 100%;">
                ...
                <div style="width: 60%; margin-left: 20%; margin-top: 10px;">
                    <el-button style="width: 245px;background-color: #456ced;color: white;">点击咨询</el-button>
                </div>
            </div>
        </el-row>
        <el-divider class="divider2"/>
        ...
        <el-divider class="divider2"/>
        <el-row :gutter="20">
        <div style="width: 96%;margin-left: 2%;background: #2f3130; color: white; text-align:center;height:80%">
        ...
        <div style="width: 96%;margin-left: 2%">
                <img class="imgPhone" :src="form.bottom.image.url">
        </div>
        </el-row>
