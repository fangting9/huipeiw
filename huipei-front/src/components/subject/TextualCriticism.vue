    ...
    <div class="el-main-div">
        ...
        <el-card class="box-card" shadow="never">
            <el-form>
                ...
                <el-row :gutter="20" class="el-row-box">
                    <el-col :span="4">教师资格证</el-col>
                    <el-col :span="18">
                        <el-row :gutter="20">
                            <el-form-item>
                                <el-input v-model="form.teacherCertification.title" placeholder="请输入标题"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row :gutter="20">
                            <el-upload
                                    ...
                                    :on-success="(res,file)=>{handleObjectAvatarSuccess(res,file,form.teacherCertification.banner)}"
                            >
                                <img v-if="form.teacherCertification.banner.url" :src="form.teacherCertification.banner.url" class="middle-avatar" />
                ...
                <el-row :gutter="20" class="el-row-box">
                    <el-col :span="3">心理咨询师</el-col>
                    <el-col :span="18">
                        <el-row :gutter="20">
                            <el-form-item>
                                <el-input v-model="form.psychologists.title" placeholder="请输入标题"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row :gutter="20">
                            <el-upload
                                    ...
                                    list-type="picture-card"
                                    :on-preview="handlePictureCardPreview"
                                    :file-list="form.psychologists.picUrls"
                            >
                                <el-icon><Plus /></el-icon>
                            </el-upload>
                        </el-row>
                ...
                <el-row :gutter="20" class="el-row-box">
                    ...
                    <el-col :span="18">
                        <el-row :gutter="20">
                            <el-form-item>
                                <el-input v-model="form.courseConsultation.title" placeholder="请输入标题"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row :gutter="20">
                            <el-upload
                                    ...
                                    :action="uploadUrl"
                                    :show-file-list="false"
                                    :on-success="(res,file)=>{handleObjectAvatarSuccess(res,file,form.courseConsultation.banner)}"
                            >
                                <img v-if="form.courseConsultation.banner.url" :src="form.courseConsultation.banner.url" class="middle-avatar" />
                                <el-icon v-else class="min-avatar-uploader-icon"><Plus/></el-icon>
                            </el-upload>
                        </el-row>
                    </el-col>
                ...
                <el-row :gutter="20" class="el-row-box">
                    <el-col :span="3">人力资源管理师</el-col>
                    <el-col :span="18">
                        <el-row :gutter="20">
                            <el-form-item>
                                <el-input v-model="form.HRMD.title" placeholder="请输入标题"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row :gutter="20">
                            <el-upload
                                    ...
                                    :action="uploadUrl"
                                    :show-file-list="false"
                                    :on-success="(res,file)=>{handleObjectAvatarSuccess(res,file,form.HRMD.banner)}"
                            >
                                <img v-if="form.HRMD.banner.url" :src="form.HRMD.banner.url" class="middle-avatar" />
                                <el-icon v-else class="min-avatar-uploader-icon"><Plus/></el-icon>
                            </el-upload>
                        </el-row>
                    </el-col>
                ...
                <el-row :gutter="20" class="el-row-box">
                    ...
                    <el-col :span="18">
                        <el-upload
                                ...
                                :action="uploadUrl"
                                :show-file-list="false"
                                :on-success="(res,file)=>{handleObjectAvatarSuccess(res,file,form.courseReservation)}"
                        >
                            <img v-if="form.courseReservation.url" :src="form.courseReservation.url" class="middle-avatar" />
                            <el-icon v-else class="min-avatar-uploader-icon"><Plus/></el-icon>
                        </el-upload>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="20" class="el-row-box">
                    <el-col :span="3">健康管理师</el-col>
                    <el-col :span="18">
                        <el-row :gutter="20">
                            <el-form-item>
                                <el-input v-model="form.healthManager.title" placeholder="请输入标题"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row :gutter="20">
                            <el-upload
                                    ...
                                    list-type="picture-card"
                                    :on-preview="handlePictureCardPreview"
                                    :file-list="form.healthManager.picUrls"
                            >
                                <el-icon><Plus /></el-icon>
                            </el-upload>
                        </el-row>
                ...
                <el-row :gutter="20" class="el-row-box">
                    ...
                    <el-col :span="18">
                        <el-row :gutter="20">
                            <el-form-item>
                                <el-input v-model="form.purchaseCourseService.title" placeholder="请输入标题"></el-input>
                            </el-form-item>
                        </el-row>
                        <el-row :gutter="20">
                        <el-upload
                                ...
                                :action="uploadUrl"
                                :show-file-list="false"
                                :on-success="(res,file)=>{handleObjectAvatarSuccess(res,file,form.purchaseCourseService.banner)}"
                        >
                            <img v-if="form.purchaseCourseService.banner.url" :src="form.purchaseCourseService.banner.url" class="middle-avatar" />
                            <el-icon v-else class="min-avatar-uploader-icon"><Plus/></el-icon>
                        </el-upload>
                        </el-row>
                    </el-col>
    ...
    export default {
        ...
        methods:{
            ...
            saveData(){
                ...
                request.psychologists.picUrls = this.transferPicUrl(this.form.psychologists.picUrls, request.psychologists.picUrls);
                request.healthManager.picUrls = this.transferPicUrl(this.form.healthManager.picUrls, request.healthManager.picUrls);

                axios.post("/admin/exam/save",request).then(() => {
